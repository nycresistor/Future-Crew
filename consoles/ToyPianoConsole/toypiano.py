...
class ToyPianoConsole:
	...
	self.noteNamesFlat = ['C', 'Db', 'D', 'Eb', 'E', 'F', 'Gb', 'G', 'Ab', 'A', 'Bb', 'B']
    ...
    def noteName(self, whichNote, accidentals='both'):
    	n = whichNote % 12
	if (accidentals=='both'):
	    if (random() > 0.5): accidentals='sharps'
	    else: accidentals='flats'

	if (accidentals=='flats'):
	    return self.noteNamesFlat[n]
	else:
	    return self.noteNames[n]
